...
Add `--headless` if you need to run in environments without a display (renders nothing but exercises the loop). The environment
variable ensures the interpreter locates the `src`-layout package.
